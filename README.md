# Dscan 新一代智能化攻击面管理与渗透测试平台
## 项目简介
Dscan​ 是一个功能全面的新一代智能化攻击面管理与渗透测试平台。它集成了资产发现、漏洞扫描、指纹识别、空间测绘等多种能力，并提供了可视化的态势大屏和专业报告输出，持续维护的POC指纹库，旨在帮助安全团队高效地进行攻击面管理和漏洞生命周期管理。

## 企鹅qq：2649566514

# 更新记录
## [v1.8]
**功能升级**：新增JS爬虫+敏感信息提取、POC/指纹更新
## [v1.7]
**功能升级**：新增资产拓扑图、威胁大屏、漏洞报告docx生成、修复已知bug
## [v1.6]
**功能升级**：新增企业信息搜集模块、AI对话升级、内置JS爬虫、其他模块优化
## [v1.5]
**功能升级**：新增敏感文件泄露检测模块、优化漏洞发现模块展示
## [v1.4]
...
# 威胁大屏
![image](https://github.com/kk12-30/Dscan/blob/main/pic/p1222-1.png)
# 首页
